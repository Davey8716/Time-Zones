...
LOCATIONS: tuple[Location, ...] = (
    ...
    Location("Iran", "Tehran", "Asia/Tehran", 1),
    ...
    Location("Afghanistan", "Kabul", "Asia/Kabul", 1),
    ...
    Location("India", "New Delhi", "Asia/Kolkata", 1),
    Location(
        "Sri Lanka",
    ...
    Location("Australia (Eucla)", "Eucla", "Australia/Eucla", 1),
    ...
    Location("Samoa", "Apia", "Pacific/Apia", 1),
    Location("Tonga", "Nukuʻalofa", "Pacific/Tongatapu", 2),
    Location(
